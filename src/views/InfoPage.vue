  ...
  <main class="flex min-h-screen flex-col items-center px-4 py-8 sm:py-12">
      ...
      <!-- Header -->
       <div class="mb-6 flex flex-col items-center text-center sm:flex-row sm:text-left">
        <div 
        class="mb-4 h-20 w-20 shrink-0 overflow-hidden rounded-full border-4 border-green-400 sm:mb-0 sm:mr-6"
        >
      ...
      <div>
        <h1 class="font-display mb-1 text-2xl font-bold text-white">{{ bio.name }}</h1>
       ...
       <div>
        ...
        <span v-for="skill in bio.skills"
          :key="skill"
       ...
       <!-- Contact -->
        <div>
          ...
          class="group inline-flex items-center gap-2 rounded-xl bg-green-500 px-6 py-3 font-medium text-white shadow-lg shadow-green-500/30 transitional-all duration-200 hover:scale-105 hover:bg-green-600 hover:shadow-xl hover:shadow-green-500/40 active:scale-95"
          >
            <svg 
            data-slot="icon" 
            fill="none" 
